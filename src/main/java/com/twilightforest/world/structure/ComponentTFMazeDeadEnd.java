...
public class ComponentTFMazeDeadEnd extends StructureComponentTF {
	...
	public ComponentTFMazeDeadEnd(int componentType, int x, int y, int z, int rotation) {
		super(componentType);
	...
	public boolean addComponentParts(World world, Random rand, BoundingBox clip) {
		fillWithBlocks(world, clip, 1, 1, 0, 4, 4, 0, FENCE, 0, AIR, 0, false);
		fillWithBlocks(world, clip, 2, 1, 0, 3, 3, 0, AIR, 0, false);
		return true;
	}
}
